...
from app.functions import harf_karistirma_bosluk_functions as functions
from app.datab import get_async_db

router = APIRouter(prefix="/exercises", tags=["exercises"])

@router.get("/harf-karistirma-bosluk")
...
@router.post("/harf-karistirma-bosluk/submit")
...
@router.post("/harf-karistirma-bosluk/complete")
