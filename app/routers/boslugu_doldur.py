...
from app.functions import boslugu_doldur_functions as functions
from app.datab import get_async_db

router = APIRouter(prefix="/exercises", tags=["exercises"])

@router.get("/boslugu-doldur")
...
@router.post("/boslugu-doldur/submit")
...
@router.post("/boslugu-doldur/complete")
