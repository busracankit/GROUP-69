...
from app.functions import hecelere_ayir_functions as functions
from app.datab import get_async_db

router = APIRouter(prefix="/exercises", tags=["exercises"])

@router.get("/hecelere-ayir")
...
@router.post("/hecelere-ayir/submit")
...
@router.post("/hecelere-ayir/complete")
