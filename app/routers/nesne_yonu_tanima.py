...
from app.functions import nesne_yonu_tanima_functions as functions
from app.datab import get_async_db

router = APIRouter(prefix="/exercises", tags=["exercises"])

@router.get("/nesne-yonu-tanima")
...
@router.post("/nesne-yonu-tanima/submit")
...
@router.post("/nesne-yonu-tanima/complete")
