...
from app.functions import ilk_harfi_yakala_functions as functions
from app.datab import get_async_db

router = APIRouter(prefix="/exercises", tags=["exercises"])

@router.get("/ilk-harfi-yakala")
...
@router.post("/ilk-harfi-yakala/submit")
...
@router.post("/ilk-harfi-yakala/complete")
