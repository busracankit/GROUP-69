...
from app.functions import kelime_ses_uyum_functions as functions
from app.datab import get_async_db

router = APIRouter(prefix="/exercises", tags=["exercises"])

@router.get("/kelime-ses-uyum")
...
@router.post("/kelime-ses-uyum/submit")
...
@router.post("/kelime-ses-uyum/complete")
