...
from app.functions import anlam_bagdastir_functions as functions
from app.datab import get_async_db

router = APIRouter(prefix="/exercises", tags=["exercises"])

@router.get("/anlam-bagdastir")
...
@router.post("/anlam-bagdastir/submit")
...
@router.post("/anlam-bagdastir/complete")
