...
from app.functions import harf_karistirma_functions as functions
from app.datab import get_async_db

router = APIRouter(prefix="/exercises", tags=["exercises"])

@router.get("/harf-karistirma")
...
@router.post("/harf-karistirma/submit")
...
@router.post("/harf-karistirma/complete")
